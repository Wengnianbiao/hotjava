...
public class CasTestWithTwoThread {
    ...
    static {
        try {
            ...
            // 获取字段偏移地址，只执行一次
            A_OFFSET = unsafe.objectFieldOffset(CasTestWithTwoThread.class.getDeclaredField("a"));
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        CasTestWithTwoThread casTest = new CasTestWithTwoThread();
